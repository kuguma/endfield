...
- **鉱石の最大採掘レート** — 地域開発レベル上限の引き上げにより増加する（例: v1.1で武陵の源石鉱が360→480）
- **マシンの最大設置台数** — 工業発展計画の追加により増える（例: v1.1で天有洪炉が2→4台、洪炉拡張Ⅱ）
- **拠点レベル・蓄積レート** — 新しい拠点レベルが追加される（例: v1.1で武陵拠点Lv3、蓄積レート12,900→26,880/h）
- **新製品・新レシピ・新マシン** — 新しい鉱石種や中間素材チェーンが追加される（例: v1.1で赤銅鉱物・壌晶チェーン）
- **貯蓄上限** — 地域開発で変動する可能性あり
