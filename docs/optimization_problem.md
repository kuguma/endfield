...
発電機（サーマルバンク）はバッテリーを消費して電力を供給する。

- 発電機の消費速度は、バッテリー生産機の生産速度の**1/4**
- 例: バッテリー生産機1台（6/min生産）に対して、発電機4台で6/min消費
- つまり発電機1台あたり1.5/min消費
- **0.25刻み**: 発電機の台数で電力消費を0.25生産機単位で調整可能

```
発電機電力供給 = 発電機台数 × (バッテリー容量 × 生産速度 / 4)
```
