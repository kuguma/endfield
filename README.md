...
[武陵 出荷製品の効率分析](docs/wuling_analysis.md) では、全7製品について同様の分析を行っています。

| 指標 | 結果 |
|---|---|
| 最高効率 | 芽針注射剤Ⅱ (+2256%) / 赤銅部品 (+2200%) |
| 利益/min最高 | 中容量武陵バッテリー (+187.7/min) |
| 損益分岐点 | 錦草ソーダ / 芽針注射剤Ⅰ / 小容量バッテリー (~0%) |

v1.1で赤銅鉱（新資源）を使用する製品が追加され、効率が大幅に向上。
...
| 武陵 | 723/min | 源石100%, 赤銅100%, 青鉄100% | [解](docs/optimization_solved_wuling.md) |

※マシン台数0.25刻み。拠点蓄積レートが律速のため実効レートはこれより低い（詳細は各解を参照）
...
- 地域の各拠点ごとに、取引券の貯蓄レートと貯蓄上限が存在
  ...
  - 各拠点の取引券蓄積レートと上限:
    ...
    | 武陵 | 天王原 | 26,880/h | 2,600,000 | 約97時間 |
