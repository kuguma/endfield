...
**v1.1対応**: 赤銅部品、中容量武陵バッテリー、芽針注射剤Aを追加。
...
※ 中容量武陵バッテリーは息壌60/min（錫晶チェーン用）を内製。汚水は赤銅精錬から30/min調達
※ 芽針注射剤Aは赤銅製ボトルを使用（鉄青不要）。清水は赤銅精錬用120 + 芽針溶液用30 + 赤銅ボトル用30 = 180
...
#### 中容量武陵バッテリー
- 錫晶（Xircon）を使用する新チェーン: 息壌→液状息壌→錫晶廃液→錫晶
- 汚水が中間体として必要（赤銅精錬の副産物として調達）
- 3,200 power × 40 sec = 128,000 unit·sec（小容量の2倍）
- 息壌60/min消費（天穹の炉の全容量を使用）→ 他の息壌消費製品と排他

### 息壌の特性

- 息壌は植物と水のみで製造でき、鉱石を消費しない
- 小容量武陵バッテリーの原材料として息壌5個が必要
- 中容量武陵バッテリーの錫晶チェーンで息壌10個（60/min）を消費
- 生産レート制限: 天穹の炉の設置上限により最大60/min
- **中容量バッテリーを作る場合、息壌の全生産能力を消費する**

### 赤銅鉱の特性

- 水力採鉱機（Hydro Mining Rig）で採掘。電力不要、清水で駆動
- 清波砦に全8台設置可能、合計120/min
- 赤銅精錬時に汚水が副産物として発生（中容量バッテリーの錫晶チェーンで利用可能）

### 汚水（Sewage）の役割

- 赤銅精錬の副産物: 赤銅鉱 + 清水 → 赤銅 + **汚水**
- 錫晶の生産に必要: 液状息壌 + **汚水** → 錫晶廃液
- 錫晶の生産でも副産物: 錫晶廃液 + 鉄青パウダー → 錫晶 + **汚水**
- 中容量バッテリー生産時、赤銅精錬と錫晶生産の両方から汚水を確保する循環構造
...
| 武陵 | SC Wuling | 128,000 | 54 | 0.000422 |
